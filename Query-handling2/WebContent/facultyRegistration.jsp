...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js" integrity="sha384-wfSDF2E50Y2D1uUdj0O3uMBJnjuUD4Ih7YwaYd1iqfktj0Uod8GCExl3Og8ifwB6" crossorigin="anonymous"></script>
    ...
    <body>
    <form action="admin/registerFaculty" method="post">
        <div class = "container">
            <div class = "row">
                <div class = "col-md-3"></div>
                <div class = "col-md-6">
                    <h1 class = "text-center">Faculty Registration</h1>
                    ...
                    <div class = "col-md-9">
                        <input type = "text" class = "form-control" name="userRole" placeholder = "user role" value="faculty" readonly>
                    </div>
                    <label class = "label col-md-3 control-label">SubjectExpert</label>
                    <div class = "col-md-9">
                        <input type = "text" class = "form-control" name="subjectExpert" placeholder = "Enter subject expert">
                    </div>
